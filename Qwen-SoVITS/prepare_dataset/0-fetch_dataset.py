...
def crawl_dataset(dataset_dir, dataset_source:str, lang:str,target_duration):
    dataset_dir = "dataset"
    os.makedirs(dataset_dir, exist_ok=True)    
    database_path = f"{dataset_dir}/processed_datas.json"
    dataset_save_path = f"{dataset_dir}/{lang}/"
...
def crawl_emilia(dataset_source, cur_id_bucket:dict, lang, dataset_save_path,target_duration, total_secs):
    ...
    if lang == "en":
        ...
        path = f"{dataset_source}/JP/*.tar" # Same for Emilia-YODAS; just replace "Emilia/" with "Emilia-YODAS/"
        split_name = "jp"
...
if __name__ == '__main__':
    ...
    crawl_dataset(args.output_dir, args.dataset_source, args.lang, args.duration)
